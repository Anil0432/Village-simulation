...
void asteroid(){
    ...
    if(transx<150){
        ...
        glBegin(GL_POLYGON);
        glVertex2f(620 - transx,440 - transx);
        glVertex2f(620 - transx,480 - transx);
        glVertex2f(690 - transx,510 - transx);
        glVertex2f(670 - transx,410 - transx);
        glVertex2f(640 - transx,415 - transx);
        glVertex2f(620 - transx,440 - transx);
        glEnd();
    ...
    drawCircle(20,650 - transx,450 - transx);
